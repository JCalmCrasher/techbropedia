...
export default function Home(props: { contents: any }) {
  ...
  return (
    <>
      <Head>
        <title>Techbropedia</title>
        <meta name="description" content="Techbropedia" />
      ...
      <section className="fh flex flex-col py-20 laptop:py-0 2xl:py-20">
        ...
        <div className="hidden laptop:block my-auto">
          <button className="animate-bounce flex items-center justify-center bg-secondary-main mx-auto rounded-full w-[44px] h-[44px]"  onClick={handleScrollToAbout}>
          ...
          <div>
            ...
            <div className="flex flex-col gap-4 mt-4 max-w-4xl">
              <p className="text-body-lg">
                The idea behind Techbropedia is to create a platform dedicated
                to documenting the stories of individuals in the Nigeria tech
                industry. The goal is to highlight the diverse backgrounds and
                experiences of people working in technology, from their
                education and early career choices to their current projects and
                contributions to the field.
              </p>

              <p className="text-body-lg">
                By sharing these stories, we hope to inspire others to pursue
                careers in tech and to showcase the many different paths that
                can lead to success in this dynamic and ever-changing industry.{" "}
              </p>
            </div>
          </div>
        </Container>
      ...
      >
        <Container>
          <h2 className="text-headline-sm sm:text-headline-md">Techbros & Techsis</h2>
                    ...
                    <div className="mt-10 flex flex-col gap-2">
                      <div className="flex items-end gap-4 mb-4">
                        ...
                        <div className="flex flex-col">
                          <span>
                            {(selectedProfile?.data?.occupation || []).join(
                              ", "
                            )}
                          </span>
                        </div>
